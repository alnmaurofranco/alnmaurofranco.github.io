"use strict";document.addEventListener("DOMContentLoaded",function(){var o=document.documentElement,e=d(".modal"),t=d(".modal-button"),n=d(".modal-background, .modal-close, .modal-card-head .delete, .modal-card-foot .button");function c(){o.classList.remove("is-clipped"),e.forEach(function(e){e.classList.remove("is-active")})}function d(e){return Array.prototype.slice.call(document.querySelectorAll(e),0)}0<t.length&&t.forEach(function(n){n.addEventListener("click",function(){var e=n.dataset.target,t=document.getElementById(e);o.classList.add("is-clipped"),t.classList.add("is-active")})}),0<n.length&&n.forEach(function(e){e.addEventListener("click",function(){c()})}),document.addEventListener("keydown",function(e){27===(e||window.event).keyCode&&c()})});
